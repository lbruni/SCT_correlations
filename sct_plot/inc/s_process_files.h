...
public:
    ...
    void pushChannel_substrip(Double_t channel_x, Double_t channel_y, Double_t Effi, Double_t NumberOfEvents, Double_t NumberOfEventsDUT, Double_t Effi_error);
    ...
    std::shared_ptr<TH1D> m_Hits_total_substrip;
    std::shared_ptr<TH1D> m_Hits_with_DUT_Hits_substrip;
    std::shared_ptr<TH1D> m_Efficieny_map_substrip;

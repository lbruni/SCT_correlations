...
namespace sct_corr{
  ...
  S_plot sct_plot::clustering(const char* name, Double_t Pixel_distance/*=2*/, plot_save_option_def save_option  /*=  save_to_disk*/)
  {

    
    return S_plot(new sct_corr::clusterSize(name, save_option == save_to_disk, Pixel_distance));
  }
